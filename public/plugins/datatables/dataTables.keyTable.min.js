...
(function (e) {
    ...
    e.extend(l.prototype, {
        blur: function () {
            ...
            if (this.c.blurable)e(j.body).on("click.keyTable", function (c) {
            ...
            if (this.c.editor)b.on("key.kt",
                function (b, d, e, h, i) {
                    a._editor(e, i)
                });
            if (b.settings()[0].oFeatures.bStateSave)b.on("stateSaveParams.keyTable", function (b, d, e) {
            ...
            var d = this, c = this.s.dt, f = c.page.info(), m = this.s.lastFocus;
            if (this.s.enable) {
                if ("number" !== typeof a) {
                ...
                if (-1 !== f.length && (a < f.start || a >= f.start + f.length))c.one("draw", function () {
                    d._focus(a,
                        b)
            ...
            var c = d[c](), f = d.outerHeight(), d = d.outerWidth(), e = b.scrollTop(), h = b.scrollLeft(),
            ...
            var c = this.s.dt, f = c.page.info(), j = f.recordsDisplay, h = this.s.lastFocus, i = this._columns();
            if (h) {
                ...
                f = i[c];
                "right" === b ? c >= i.length - 1 ? (g++, f = i[0]) : f = i[c + 1] : "left" ===
                b ? 0 === c ? (g--, f = i[i.length - 1]) : f = i[c - 1] : "up" === b ? g-- : "down" === b && g++;
