...
public class Module extends AbstractModule {
	...
	public void configure() {
		...
		// application starts.
		// bind(ICompte.class).to(CompteImplementation.class);
		bind(DSLContext.class).toProvider(DSLContextProvider.class);

	}
	/*
	 * public void configure() { // Use the system clock as the default
	 * implementation of Clock
	 * bind(Clock.class).toInstance(Clock.systemDefaultZone()); // Ask Guice to
	 * create an instance of ApplicationTimer when the // application starts.
	 * //bind(ApplicationTimer.class).asEagerSingleton(); // Set AtomicCounter
	 * as the implementation for Counter. <<<<<<< HEAD
