...
public class ContactDetail extends TableImpl<ContactDetailRecord> {
    ...
    private static final long serialVersionUID = -459505892;
    ...
    /**
     * The column <code>public.contact_detail.student_fk</code>.
     */
    public final TableField<ContactDetailRecord, String> STUDENT_FK = createField("student_fk", org.jooq.impl.SQLDataType.VARCHAR.length(30), this, "");

    /**
     * The column <code>public.contact_detail.id</code>.
     */
    public final TableField<ContactDetailRecord, Long> ID = createField("id", org.jooq.impl.SQLDataType.BIGINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("nextval('contact_detail_id_seq'::regclass)", org.jooq.impl.SQLDataType.BIGINT)), this, "");
     ...
     */
    @Override
    public Identity<ContactDetailRecord, Long> getIdentity() {
        return Keys.IDENTITY_CONTACT_DETAIL;
    }
