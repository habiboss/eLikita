...
public class RoUsers extends TableImpl<RoUsersRecord> {
    ...
    private static final long serialVersionUID = 93889627;

    /**
     * The reference instance of <code>public.ro_users</code>
     */
    ...
    /**
     * The column <code>public.ro_users.id</code>.
     */
    public final TableField<RoUsersRecord, Long> ID = createField("id", org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>public.ro_users.user</code>.
     */
    public final TableField<RoUsersRecord, String> USER = createField("user", org.jooq.impl.SQLDataType.VARCHAR.length(50), this, "");

    /**
     * The column <code>public.ro_users.user_type</code>.
     */
    ...
    /**
     * The column <code>public.ro_users.comptable</code>.
     */
    ...
    /**
     * The column <code>public.ro_users.service</code>.
     */
    ...
    /**
     * The column <code>public.ro_users.user_name</code>.
     */
    ...
    /**
     * The column <code>public.ro_users.date_created</code>.
     */
    ...
    /**
     * The column <code>public.ro_users.disable_date</code>.
     */
    ...
    /**
     * The column <code>public.ro_users.granted_numbering</code>.
     */
    ...
    /**
     * Create a <code>public.ro_users</code> table reference
     */
    public RoUsers() {
        this("ro_users", null);
    }
    ...
    /**
     * Create an aliased <code>public.ro_users</code> table reference
     */
